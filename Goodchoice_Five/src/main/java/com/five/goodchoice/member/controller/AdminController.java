...
public class AdminController {
	...
	public String main(HttpServletRequest request) {
	 ...
	 return "main/home.tiles1"; // /WEB-INF/views/tiles1/{1}/{2}.jsp }
	  ...
	  public String empmanager_acomm_approve(HttpServletRequest request) {
	...
	public int empmanager_updatePermissionAcomm(HttpServletRequest request) {
	...
	public String empmanager_showAllHost(HttpServletRequest request) {
	...
	public int empmanager_updatePermission(HttpServletRequest request) {
...
//  ===  HOST 리스트 Exel파일로 다운받기  ====
	...
	// 호스트 메인 화면
	@RequestMapping(value="/main/hosthome.gc") // tiles test 입니다. public String
	public String hosthome(HttpServletRequest request) {
	  
	  List<Map<String, String>> reviewList = service.getReviewList();
	  
	  request.setAttribute("reviewList", reviewList);
	  
	 return "main/hosthome.tiles6"; // /WEB-INF/views/tiles1/{1}/{2}.jsp }
	}
