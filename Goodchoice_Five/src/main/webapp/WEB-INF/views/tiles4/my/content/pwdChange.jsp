...
<style type="text/css"> 
	.box_pwdChange { border:1px solid #e4e4e4; width:600px; margin:20px auto; background:#fbfbfb; padding: 65px 0 85px 0; box-sizing: border-box; font-family: "Pretendard Variable", Pretendard, -apple-system, BlinkMacSystemFont, system-ui, Roboto, "Helvetica Neue", "Segoe UI", "Apple SD Gothic Neo", "Noto Sans KR", "Malgun Gothic", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", sans-serif; }
    ...
    .box_pwdChange .input-box > input{ background:transparent; border:none; padding:27px 0px 7px 5px; font-size:14pt; width:100%;  display: block; border-radius: 3px;}
...
$(document).ready(function(){
	$("span.password_button_orange").click(function(){
		...
		if(!bool) {
			...
			frm.action = "<%= ctxPath%>/pwdChangeEnd.gc";
			frm.method = "POST";
			frm.submit();
		}
...
<form name="pwdChangeForm" method="post">
        ...
        <div class="box_pwdChange">
            <div class="password_title1"><span>비밀번호</span> 변경</div> 
