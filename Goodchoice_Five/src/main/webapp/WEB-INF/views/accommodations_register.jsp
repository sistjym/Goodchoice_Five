...
<script type="text/javascript">
	      ...
	      $('#dropArea').on('drop', function(event) {
	        ...
	        if (files.length > 0) {
	            ...
	            for (var i = 0; i < files.length; i++) {
	              ...
	              fileInfo += '파일 이름: ' + fileName + '<br>';
	              fileInfo += '확장자: ' + getFileExtension(fileName) + '<br>';
	              fileInfo += '파일 크기: ' + formatFileSize(fileSize) + '<br><br>';
	            }
	...
	/* function addImage(){
		 ...
		 fileInput.attr('accept', '.gif, .jpg, .png'); // 이미지 파일 확장자 제한
		 fileInput.click();
      ...
      <tr class="align-bottom">
        ...
        <td>
        	...
        	<div style="margin-top:30px;">
        		<button id="addImage" type="button" class="btn_image">+이미지 추가</button>
        			  <div id="myModal" class="modal">
					    <div class="modal-content">
					      <span class="modal-close">&times;</span>
					      <h3>드래그 앤 드롭 영역</h3>
					      <div class="drop-area" id="dropArea">이곳에 이미지를 드롭하세요</div>
